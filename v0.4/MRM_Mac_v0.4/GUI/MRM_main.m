...
% We set the tooltip text here rather than in the objects themselves so
% that we can use the sprintf() function to get multiline text and also it
% makes the tooltips easier to find and edit.

%-------------------------------------------------------------------------%
% Within-subjects factor number                                           %
%-------------------------------------------------------------------------%
% switch MRM.Model  
%     case 'Repeated' 
%         set(handles.WSFactorsNum, 'TooltipString', ...
%             sprintf('The number of within-subject (repeated measures) factors.'));
%         
%     case 'MANOVA'
%         set(handles.WSFactorsNum, 'TooltipString', ...
%             ['The number of dependent variables. Setting this to 1 will ' ...
%             'result in a traditional mass univariate analysis']);
% end
% 
% %-------------------------------------------------------------------------%
% % Between-subjects factor number                                          %
% %-------------------------------------------------------------------------%
% set(handles.BSFactorsNum, 'TooltipString', ...
%     sprintf('The number of between-subject (non-repeated) factors.'));
% 
%          
% %-------------------------------------------------------------------------%
% % Output directory                                                        %
% %-------------------------------------------------------------------------%
% s = sprintf(['Where do you want the analysis saved? \n' ...
%              'If the directory does not exist it will be created.']);
% 
% set(handles.outDirText, 'TooltipString', s);
% set(handles.outputDirText, 'TooltipString', s);
