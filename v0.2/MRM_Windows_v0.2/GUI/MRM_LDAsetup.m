...
[Ev, EigVecRaw, UnstandDF, StandDF, varExpl, ~, centroids] = MRM_LDA(Y, X, L, GroupNum, ...
...
if get(handles.varExplTick, 'Value') == 1
    ...
    displaytable([Ev varExpl], {'Eigenvalues', 'Variance (%)'})
...
if get(handles.stdLDTick, 'Value') == 1
   ...
   displaytable(StandDF, labs, [], [], rows)
...
if get(handles.UnstdDFTick, 'Value') == 1
   ...
   displaytable(UnstandDF, labs, [], [], rows)
...
if get(handles.centroidsTick, 'Value') == 1
   ...
   for i = 1:size(StandDF,2)
    ...
    displaytable(centroids, labs, [], [], Xlabels)
...
% --- Executes on button press in returnScoresTick.
function returnScoresTick_Callback(hObject, eventdata, handles)
% hObject    handle to returnScoresTick (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of returnScoresTick
...
% Hint: get(hObject,'Value') returns toggle state of plotScores


% --- Executes on button press in centroidsTick.
function centroidsTick_Callback(hObject, eventdata, handles)
% hObject    handle to centroidsTick (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of centroidsTick
