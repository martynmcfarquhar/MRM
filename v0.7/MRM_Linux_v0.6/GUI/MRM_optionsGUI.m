...
MRMoptions.BootPiResamps = str2num(get(handles.bootNumBox,              'String'));
MRMoptions.BootPiZero    = get(handles.bootQbutton,                     'Value');
MRMoptions.PiZeroOne     = get(handles.setPiToOneButton,                'Value');
