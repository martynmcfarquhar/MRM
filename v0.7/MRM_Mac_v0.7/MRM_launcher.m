...
if ~isempty(findobj('type','figure','name','Repeated measures for neuroimaging')) || ...
   ~isempty(findobj('type','figure','name','MANOVA for neuroimaging'))
